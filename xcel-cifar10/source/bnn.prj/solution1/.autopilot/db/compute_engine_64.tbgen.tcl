set moduleName compute_engine_64
set isTopModule 0
...
set C_modelName {compute_engine_64}
...
set C_modelArgMapList {[ 
	{ "Name" : "b_V", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "w_V", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ b_V sc_in sc_lv 64 signal 0 } 
	{ w_V sc_in sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "w_V", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "w_V", "role": "default" }} , 
