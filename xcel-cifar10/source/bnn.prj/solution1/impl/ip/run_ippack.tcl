...
set Library     "hls"
set IPName      "FracNet_T"
set Version     "1.0"
set DisplayName "Fracnet_t"
...
set sdx_kernel_name "FracNet_T"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/renzom/home/prj/FracBNN/xcel-cifar10/source/bnn.prj/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {FracNet_T_mux_336cvx
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL m_axi_IMG m_axi_RESULT"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_IMG {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_IMG"
        data_width "64"
        param_prefix "C_M_AXI_IMG"
    ...
    m_axi_RESULT {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_RESULT"
        data_width "32"
        param_prefix "C_M_AXI_RESULT"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 28012 II x}
