...
# Create project
create_project -force ${_xil_proj_name_} ./${_xil_proj_name_} -part xczu5eg-sfvc784-1-e
...
set_property -name "part" -value "xczu5eg-sfvc784-1-e" -objects $obj
...
set_property -name "target_part" -value "xczu5eg-sfvc784-1-e" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu5eg-sfvc784-1-e -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu5eg-sfvc784-1-e -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
